...
const DEFAULT_CATEGORIES = [
  ...
  { name: 'Starches', description: 'Swallows & starchy sides (pounded yam, eba, fufu, plantain)', sortOrder: 7 },
  { name: 'Pasta', description: 'Italian-style pasta dishes', sortOrder: 8 },
  { name: 'Rice Dishes', description: 'Rice-based meals (jollof, fried rice, etc.)', sortOrder: 9 },

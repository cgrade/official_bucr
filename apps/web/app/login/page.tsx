  ...
  return (
    <div className="max-w-md mx-auto px-5 py-16">
      <div className="text-center mb-8">
        ...
        <h1 className="mt-6 font-display text-3xl font-semibold text-[#0f2547]">Welcome back</h1>
        <p className="mt-1 text-[14px] text-[#7a8fa6]">Sign in to book and manage your reservations.</p>
      </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="max-w-md mx-auto px-5 py-16 text-center text-[#7a8fa6]">Loading…</div>}>
      <LoginForm />
    </Suspense>
  );
}

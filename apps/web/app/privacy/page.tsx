...
export default function PrivacyPage() {
  return (
    <div className="max-w-2xl mx-auto px-5 py-14">
      <h1 className="font-display text-4xl font-semibold text-[#0f2547]">Privacy Policy</h1>
      <p className="text-[13px] text-[#7a8fa6] mt-1 mb-8">Last updated: June 2026 · Consistent with the Nigeria Data Protection Act 2023.</p>

...
const SECTIONS: { h: string; body: string }[] = [
  ...
  { h: '4. Cancellations', body: 'Guest cancellations are refunded as follows: 24 hours or more before the booking — 100%; between 12 and 24 hours — 50%; under 12 hours — 0%. If a vendor cancels, the guest receives 100% plus a 10% compensation bonus.' },
  ...
  { h: '6. Vendor terms', body: 'Vendors are billed a flat per-cover success fee on seated guests and may subscribe to paid tiers. Vendor credits are earned via no-show compensation and promotions, can only be spent on Bucr marketing inventory, and can never be withdrawn to cash.' },
